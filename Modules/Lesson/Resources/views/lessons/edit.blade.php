          ...
          @method('PUT')
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('title') is-invalid  @enderror" name="title" id="title" value="{{ $lesson->title }}" placeholder="">
              ...
              <div class="form-group col-md-6">
                <label for="grade">مقطع تحصیلی</label>
                  <select class="form-control @error('grade') is-invalid  @enderror" name="grade" id="grade">
                    ...
                    <option {{ $lesson->grade == 'MD' ? 'selected' : '' }} value="MD">فوق دکتری</option>
                    <option {{ $lesson->grade == 'PhD' ? 'selected' : '' }} value="PhD">دکتری</option>
                    <option {{ $lesson->grade == 'Master(MSc/MA)' ? 'selected' : '' }} value="Master(MSc/MA)">کارشناسی ارشد</option>
                    <option {{ $lesson->grade == 'Bachelor(BSc/BA)' ? 'selected' : '' }} value="Bachelor(BSc/BA)">کارشناسی</option>
                    <option {{ $lesson->grade == 'Associate' ? 'selected' : '' }} value="Associate">کاردانی</option>
                  </select>
            ...
            <div class="form-row">             
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('theoretic_unit') is-invalid @enderror" name="theoretic_unit" id="theoretic_unit" value="{{ $lesson->theoretic_unit }}" placeholder="">
                <x-input-validation-error name="theoretic_unit" />
              </div>
              <div class="form-group col-md-6">
                <label for="practical_unit">واحد عملی</label>
                <input type="text" class="form-control @error('practical_unit') is-invalid  @enderror" name="practical_unit" id="practical_unit" value="{{ $lesson->practical_unit }}" placeholder="">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <select class="form-control @error('teacher_id') is-invalid  @enderror" name="teacher_id" id="teacher_id">
                  ...
                  <option value="{{ $teacher->id }}" {{ $teacher->id == $lesson->teacher_id ? 'selected' : '' }}>{{ $teacher->name }}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('exam_date') is-invalid  @enderror" name="exam_date" id="exam_date" value="{{ $lesson->exam_date }}" placeholder="">
